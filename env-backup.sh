...
BACKUP_DIR="${BASEPATH}/nginx/apps-env/ec-demo-shipping"

# バックアップ対象ファイル（相対パス）
ENV_FILES=(
    "docker/.env"
    "apps/api/.env"
    "apps/admin-next-shadcn/.env.production"
    "apps/admin-square-ui/.env.local"
    "apps/admin-antd-pro/.env"
    "apps/admin-horizon-ui/.env.local"
    "apps/admin-mui/.env"
    "apps/admin-mui/.env.production"
)
