...
-- Delete existing data before inserting sample data
DELETE FROM shippings;

-- Insert sample data for development/testing (100 records)
-- Status distribution: CREATED(20), READY(20), SHIPPED(30), DELIVERED(25), RETURNED(5)
-- Carrier distribution: YAMATO(~33%), SAGAWA(~33%), JAPAN_POST(~34%)
INSERT INTO shippings (order_id, status, carrier, tracking_number, shipping_address, ready_at, shipped_at, delivered_at, version) VALUES
  ...
  -- READY (20 records) - Ready for shipment, no carrier yet
  ...
  -- SHIPPED (30 records) - With carriers and tracking numbers
  ...
  -- DELIVERED (25 records) - Successfully delivered
  ...
  -- RETURNED (5 records) - Delivery failed and returned
